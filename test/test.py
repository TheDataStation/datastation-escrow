...
if __name__ == '__main__':
    ...
    with multiprocessing.Manager() as manager:
        ...
        # call available APIs
        client_api.call_api("preprocess", cur_token, accessible_data_dict, data_accessed_dict)
        print("preprocess finished\n")
        client_api.call_api("modeltrain", cur_token, accessible_data_dict, data_accessed_dict)
        print("modeltrain finished\n")
        client_api.call_api("predict", cur_token, accessible_data_dict, data_accessed_dict, 10, 5)
