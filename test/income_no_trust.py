...
if __name__ == '__main__':
    ...
    for cur_num in range(num_users):
        ...
        for cur_type in train_type:
            ...
            cur_cipher_name = "test/ml_file_no_trust/training_income/train" + str(cur_num) + "_" + cur_type + ".pkl"
    ...
    for cur_num in range(num_users):
        ...
        train_type = ["X", "y"]
        for cur_type in train_type:
            cur_train = "test/ml_file_no_trust/training_income/train" + str(cur_num) + "_" + cur_type + ".pkl"
